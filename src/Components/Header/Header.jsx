...
const Header = () => {
  return (
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      ...
      <FaCar  size={32} />
        <span class="self-center text-2xl font-semibold whitespace-nowrap">TataVision</span>
      </NavLink>
      <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <NavLink to='/chatbot' className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center">Get started</NavLink>
